package week5.lim.StackQueue.truck;
...
public class truck {
    ...
    public static void main(String[] args) {
        ...
        int weight1 = 10;
        int[] trucks1 = {7, 4, 5, 6};
        System.out.println(solution(bridge_length1, weight1, trucks1)); // 8

        int bridge_length2 = 100;
        int weight2 = 100;
        int[] trucks2 = {10};
        System.out.println(solution(bridge_length2, weight2, trucks2)); // 101

        int bridge_length3 = 100;
        int weight3 = 100;
        int[] trucks3 = {10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
        System.out.println(solution(bridge_length3, weight3, trucks3)); // 110
    }
}
