package week15.lim.programmers_Lv2.n_17677;
...
public class Solution {
    ...
    public static int solution(String str1, String str2) {
        ...
        union -= intersection; // 합집합 크기에서 교집합 중복 제거
    ...
    // 모든 문자를 소문자로 변환 후 문자열을 다중집합으로 변환하는 함수
    private static Map<String, Integer> makeMultiSet(String str) {
        ...
        for (int i = 0; i < str.length() - 1; i++) {
            ...
            if (pair.matches("[a-z]{2}")) { // 영문자 쌍만 유효
