package week15.lim.programmers_Lv2.n_131127;
...
public class Solution {
    ...
    public static int solution(String[] want, int[] number, String[] discount) {
        ...
        // 현재 10일간의 제품 수량을 저장할 Map
        Map<String, Integer> currentMap = new HashMap<>();

        // 초기 10일간의 제품 목록을 currentMap에 저장
        for (int i = 0; i < 10; i++) {
        ...
        for (int i = 10; i < discount.length; i++) {
            ...
            // 현재 10일간의 제품 목록이 원하는 목록과 일치하는지 확인
            if (checkMatch(wantMap, currentMap)) {
                answer++;
            }
        }
    ...
    // 현재 할인 품목 목록이 원하는 품목과 일치하는지 확인하는 함수
    private static boolean checkMatch(Map<String, Integer> wantMap, Map<String, Integer> currentMap) {
